...
Браузерное расширение для Chrome и Firefox (Manifest V3), которое извлекает информацию о компании со страниц Habr (https://habr.com/ru/companies/*) и отправляет её в корпоративный сервис.
...
1. Откройте `chrome://extensions` в Chrome или `about:debugging#/runtime/this-firefox` в Firefox
2. Включите **Режим разработчика**
3. Нажмите **Загрузить распакованное расширение** / **Временное дополнение**
4. Выберите папку проекта `browser-extension`
