...
'''
habrcrawler web crawler, main program
'''
import sys
import os
import faulthandler
...
import habrcrawler.stats as stats
import habrcrawler.timer as timer
import habrcrawler.memory as memory
...
ARGS = argparse.ArgumentParser(description='habrcrawler web crawler')
...
def main():
    ...
    loglevel = os.getenv('habrcrawler_LOGLEVEL')
    if loglevel == '':
        loglevel = None
    ...
    if os.getenv('habrcrawler_GC_DEBUG') is not None:
    ...
    crawler = habrcrawler.Crawler(**kwargs)
