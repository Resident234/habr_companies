...
def test_make_list():
    configfile = 'foo'
    ret = ['foo',
           '/home/kilroy/bar/.habrcrawler-config.yml',
           '/home/kilroy/.habrcrawler-config.yml',
           '/home/.habrcrawler-config.yml']

    with mock.patch('habrcrawler.config.os.getcwd', return_value='/home/kilroy/bar'):
