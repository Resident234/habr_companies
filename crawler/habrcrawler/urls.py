'''
URL class and transformations for the habrcrawler.
...
See habrcrawler/data/html-parsin-test.html for an analysis of browser
transformations.
...
def clean_webpage_links(link, urljoin=None):
    ...
    Also, since habrcrawler allows a variety of html parsers, it's likely that
    ...
    See manual tests in habrcrawler/data/html-parsing-test.html
