...
CREATE TABLE posts (
    ...
    CONSTRAINT fk_posts_action_dev      FOREIGN KEY (action_dev)      REFERENCES statuses (code) ON UPDATE CASCADE,
    CONSTRAINT fk_posts_action_post     FOREIGN KEY (action_post)     REFERENCES statuses (code) ON UPDATE CASCADE,
    CONSTRAINT fk_posts_action_comment  FOREIGN KEY (action_comment)  REFERENCES statuses (code) ON UPDATE CASCADE,
    CONSTRAINT fk_posts_action_industry FOREIGN KEY (action_industry) REFERENCES statuses (code) ON UPDATE CASCADE,
    CONSTRAINT fk_posts_action_company  FOREIGN KEY (action_company)  REFERENCES statuses (code) ON UPDATE CASCADE
