...
CREATE TABLE articles (
    ...
    CONSTRAINT fk_articles_action_dev      FOREIGN KEY (action_dev)      REFERENCES statuses (code) ON UPDATE CASCADE,
    CONSTRAINT fk_articles_action_post     FOREIGN KEY (action_post)     REFERENCES statuses (code) ON UPDATE CASCADE,
    CONSTRAINT fk_articles_action_comment  FOREIGN KEY (action_comment)  REFERENCES statuses (code) ON UPDATE CASCADE,
    CONSTRAINT fk_articles_action_industry FOREIGN KEY (action_industry) REFERENCES statuses (code) ON UPDATE CASCADE,
    CONSTRAINT fk_articles_action_company  FOREIGN KEY (action_company)  REFERENCES statuses (code) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
